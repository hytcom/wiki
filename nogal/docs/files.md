...
|[basePaths](#basePaths)|Retorna la porci�n com�n de dos paths desde el inicio. Previa a la comparaci�n limpia los paths con nglCommon::clearPath|
...
|[lsprint](#lsprint)|imprime el �rbol de un directorio de manera recursiva|
|[maxUploadSize](#maxUploadSize)|Retorna el m�ximo tama�o de archivo soportado por al configuraci�n del servidor|
|[mkdirr](#mkdirr)|Crea un directorio. Si el directorio ya existe y $bForce es TRUE, mkdir le agregar� al nombre del directorio el sufijo _N donde N es el n�mero de di...|
