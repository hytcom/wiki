...
|Método|Descripción|
|---|---|
|[format](#format)|Formatea un valor en segundos, seg�n $sFormat|
|[microtimer](#microtimer)|Retorna la cantidad de segundos transcurridos desde $nTimeIni|
|[now](#now)|Retorna un array con los nombres de los d�as de la semana y meses del a�o en el array bidimensional basado en los valores de las constantes NGL_DATE...|
|[settings](#settings)|Retorna un array con los nombres de los d�as de la semana y meses del a�o en el array bidimensional basado en los valores de las constantes NGL_DATE...|
