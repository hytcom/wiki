...
|Método|Descripción|
|---|---|
|[GetMode](#GetMode)|Selecciona el modo de salida para los m�todos get y getall|
...
|[toArray](#toArray)|Obtiene todas las filas de resultados en forma de array bidimensional utilizando mysqli_result::fetch_array en modo asociativo.Este m�todo ignora los...|
