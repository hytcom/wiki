...
<blockquote>**\$_SESSION[NGL_SESSION_INDEX]["LOGIN"]["ALVIN_TOKEN"]**<blockquote>  
 ...
 *block* function ( *V* content, *C* die );  
 ...
 *block* function ( *C* iff, *A* then, *A* else, ** isset, ** in, *L* notin, *V* needle, *S* setmode, ** splitter, *I* content );  
 ...
 *block* function ( *N* name, *O* source, ** type, *I* debug, *R* index, ** tree, *I* from, *I* limit, *I* step, ** order, *C* zerofill, *C* content, *C* empty );  
 ...
 *block* function ( *C* data, *R* source, ** multiple );  
 ...
 *block* function ( *E* content, *D* print );  
 ...
 *block* function ( *N* name, *N* value, ** operator, ** method, ** userpwd, *C* splitter, *C* linebreak, ** index, ** structure, ** keys );  
