...
|Método|Descripción|
|---|---|
|[CalculatePosition](#CalculatePosition)|Calcula el TOP y LEFT en base al alto y ancho de la imagen y el alto y ancho del...|
|[CalculateSizes](#CalculateSizes)|Calcula el el ancho y alto de una imagen y su lienzo manteniendo la proporcional...|
...
|[load](#load)|Carga la imagen en el objeto.Si el parámetro $mFile fuese null, se creará una im...|
|[margin](#margin)|Añade un margen por fuera de los limites de la imagen.Si una imagen mide 100px d...|
|[merge](#merge)|Inserta una imagen dentro de otra|
|[padding](#padding)|Añade un margen por dentro de los limites de la imagen.Si una imagen mide 100px ...|
|[replace](#replace)|Reemplaza un color por otro.El reemplazo de colores en una imagen no es algo sen...|
