...
- [GetID = Obtiene el ID del registro **\$mID** de la tabla **\$sTable** confirmando la existencia del mismo, en base a su IMYA o al propio ID](#GetID)
- [Logger = Registra la salida de LOG de un método en los atributos **log** y **history**](#Logger)
- [OwLog = Genera un log sobre cada acción de escritura](#OwLog)
...
- [columns = ](#columns)
- [connect = ](#connect)
- [delete = Utiliza el método **nglOwl::UpdateData** para intentar eliminar el o los registros seleccionados, ya sean del una tabla principal o de una dependiente (hijo)](#delete)
- [describe = ](#describe)
- [duplicate = Duplica un registro con o sin sus dependencias (hijos)](#duplicate)
- [get = ](#get)
- [getAll = ](#getAll)
- [insert = Inserta uno o mas registros en las tablas que componen los objetos](#insert)
- [query = ](#query)
- [relationship = ](#relationship)
- [select = ](#select)
- [showtables = Retorna un Array con los datos de todos los elementos que componen el sistema **DB**](#showtables)
- [suspend = Suspende uno o mas registros aplicando la misma lógica que el método **nglOwl::update**, con la diferencia de que sólo un campo es actualizado; **state = 0**
Cuando un registro principal es suspendido, todos sus registros dependientes también lo son](#suspend)
- [toggle = Suspende y/o desuspende uno o mas registros aplicando la misma lógica que el método **nglOwl::update**, con la diferencia de que sólo un campo es actualizado; **state = 0**
Cuando un registro principal es suspendido, todos sus registros dependientes también lo son](#toggle)
- [unsuspend = Reactiva registros suspendidos por **nglOwl::suspend**, actualizando **state = 1**
Cuando un registro principal es reactivado, todos sus registros dependientes también lo son](#unsuspend)
- [update = Actualiza uno o mas registros en las tablas que componen los objetos](#update)
- [view = ](#view)
