...
|**multiple**|Cadena ó archivo JSON con las rutas relativas a **source** de cada plantilla y los datos enriquecidos para cada una de ellas<br />Formato:<br />```html[<blockquote>["template1.html", {"title":"foo", "text":"bar"}],<br />["template2.html", {"value":"foo", "option":"bar"}],<br />["templateN.html", {"name":"foo", "lastname":"bar"}<blockquote>]```|
