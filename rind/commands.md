...
|Parámetro|Descripción|
|---|---|
|**index**|Valor númerico que indica la posición del array que se desea obtener cuando se utiliza el **method** es **element** ó nombre del indice del sub-array que hará de clave en el método **vector**<br />|
|**keys**|Lista de valores separados por coma (,) utilizados cuando se emplea el método **chkeys**<br />|
